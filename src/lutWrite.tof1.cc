...
void
fatInit_tof1(float field = 0.5, float rmin = 100.)
{
  fat.SetBField(field);
  ...
  fat.AddLayer((char*)"ddd4",   20.,  0.03, 0.03,   resRPhiOB, resZOB, eff); // 3% X0
...
void
lutWrite_tof1(const char *filename = "lutCovm.dat", int pdg = 211, float field = 0.2, float rmin = 20.)
{
