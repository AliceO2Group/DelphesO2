...
void fatInit_its3(float field = 0.5, float rmin = 100.) {
  ...
  fat.AddLayer((char *)"ddd1", 1.8, x0, xrhoOB, resRPhi, resZ, eff);
  fat.AddLayer((char *)"ddd2", 2.4, x0, xrhoOB, resRPhi, resZ, eff);
  fat.AddLayer((char *)"ddd3", 3.0, x0, xrhoOB, resRPhi, resZ, eff);
