...
### run configuration
NJOBS=40        # number of max parallel runs
NRUNS=40        # number of runs
...
for I in $(seq 0 $(($NRUNS - 1))); do
    ...
    DelphesHepMC propagate.tcl delphes.$I.root D0-gun.hepmc &> delphes.$I.log && \
...
ls -d $PWD/AODRun5.*.root >> listfiles.txt
