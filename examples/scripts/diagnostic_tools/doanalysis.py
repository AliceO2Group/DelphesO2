...
analyses = {"TrackQA": ["o2-analysis-qa-simple",
            ...
            "TreeD0": ["o2-analysis-hf-tree-creator-d0-to-k-pi --aod-writer-keep AOD/HFCANDP2Full/0,AOD/HFCANDP2FullE/0,AOD/HFCANDP2FullP/0",
                       "o2-analysis-pid-tpc",
                       "o2-analysis-pid-tof",
...
def main(mode,
    ...
    def build_list_of_files(file_list):
        files_per_batch = []
        iter_file_list = iter(file_list[0:n_max_files])
        for i in range(0, len(file_list[0:n_max_files])):
    ...
    if type(input_file) is list:
        if batch_size == 1:
            input_file_list = input_file[0:n_max_files]
        else:
